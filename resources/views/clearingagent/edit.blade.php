                ...
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                              <form action="{{ route('clearingagent.update', $clearingagent->id )}}" method="post">
                                @method('PUT')
                                @csrf
                                <tbody><tr>
                                    <td style="width: 50%;" valign="top">
                                        <div class="form-group">
                                            ...
                                            <input name="currency" type="text"  class="form-control" value = "{{ $clearingagent->name }}" autofocus="" style="width:50%;" required>
                                            <span id="ctl00_ContentPlaceHolder1_rfvfname" style="color:Red;display:none;">Name</span>
                                        </div>
