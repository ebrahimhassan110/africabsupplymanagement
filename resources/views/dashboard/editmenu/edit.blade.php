                                            ...
                                            <td>
                                                <?php
                                                    ...
                                                    foreach($menuroles as $menurole){
                                                        if($role->id == $menurole->role_id){
                                                            $temp = true;
                                                        }
                                                    }
                                                    if($temp === true){
                                                        echo '<input checked type="checkbox" name="role[]" value="' . $role->id . '" class="form-control"/>';
                                                    }else{
                                                        echo '<input type="checkbox" name="role[]" value="' . $role->id . '" class="form-control"/>';
                                                    }
                                                ?>
                                            </td>
                                            <td>
