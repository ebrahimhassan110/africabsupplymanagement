        ...
        @php
          ...
          <div class="row">
           ...
           <div class="row">
            <div class="col-4">
              <label><b> 
                        Alternate PFI Value<span class="required"> *</span></b></label>
            </div>
            <div class="col-2">
            <input readonly name="pfi_no" type="text"  class="form-control" value="{{ $prebooking->alternate_currency }}"  placeholder="PFI No" autofocus="" style="width:100%;" required>
                    </div>

                     <div class="col-2">
             <input readonly name="pfi_value" id="pfi_value" placeholder="Amount" type="number" value="{{ $prebooking->alternate_currency_value }}"  class="form-control"  autofocus="" style="width:100%;" required>
                     </div> 
