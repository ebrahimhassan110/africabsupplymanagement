                                  ...
                                  <tbody>
                                                              ...
                                                              <div class="form-group">
                                                                  <label>
                                                                      Supplier Name : 
                                                                       ...
                                                                       <b> {{ $prebooking->supplier->supplier_name }} </b>
                                                      ...
                                                      <tr>
                                                               ...
                                                               <tr>
                                                                    ...
                                                                    <td hidden  style="width: 33%;" valign="top">
                                                                         <div class="form-group">
                                                                              <label>
                                                               ...
                                                               <tr>
                                                                  ...
                                                                  <tr>
                                                                    ...
                                                                    @if($prebooking->declaration_type=='PARTIAL')
                                                                    <td style="width: 33%;" valign="top">
                                                                         <div class="form-group">
                                                                              <label>
                                                                                Bank Value
