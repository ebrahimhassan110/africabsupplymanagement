              ...
              <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <div class="card">
                    <div class="card-header d-flex flex-row justify-content-between">
                      <span class="card-title">{{ 'Edit Institute' }} {{ 'Edit' }}</span>
                  
                    </div>
                    <div class="card-body">
                   
                            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                              <form action="{{ route('institute.update', $institute->instituteId )}}" method="post">
                                @method('PUT')
                                @csrf
                                <tbody><tr>
                                    <td style="width: 50%;" valign="top">
                                        <div class="form-group">
                                            ...
                                            <input name="instituteName" type="text"  class="form-control" value = "{{ $institute->instituteName }}" autofocus="" style="width:50%;" required>
