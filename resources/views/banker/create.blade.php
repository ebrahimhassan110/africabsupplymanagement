              ...
              <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <div class="card">
                    <div class="card-header d-flex flex-row justify-content-between">
                      <span class="card-title">{{ 'Banker' }}</span>
                  
                    </div>
                    <div class="card-body">
                   
                            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                              <form action="{{ route('banker.store')}}" method="post">
                                @csrf
                                <tbody><tr>
                                    ...
                                    <td style="width: 50%;" valign="top">
                                        <div class="form-group">
                                            ...
                                            <input name="description" type="text"  value="{{ old('description')}}" class="form-control" autofocus="" style="width:50%;" required>
										  ...
										  <div class="form-group">
                                            ...
                                            <input name="city" type="text"  value="{{ old('city')}}" class="form-control" autofocus="" style="width:50%;" required>
										  ...
										  <div class="form-group">
                                            ...
                                            <input name="country" type="text"  value="{{ old('country')}}" class="form-control" autofocus="" style="width:50%;" required>
                                            <span id="ctl00_ContentPlaceHolder1_rfvfname" style="color:Red;display:none;"> Agent Name</span>
                                        </div>
										  ...
										  <div class="form-group">
                                            ...
                                            <input name="mobile_no" type="text"  value="{{ old('mobile_no')}}" class="form-control" autofocus="" style="width:50%;" required>
										  ...
										  <div class="form-group">
                                            ...
                                            <input name="email" type="text"  value="{{ old('email')}}" class="form-control" autofocus="" style="width:50%;" required>
                                            <span id="ctl00_ContentPlaceHolder1_rfvfname" style="color:Red;display:none;"> Agent Name</span>
                                        </div>
